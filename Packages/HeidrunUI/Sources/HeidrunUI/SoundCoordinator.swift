...
/// coordinator per connected session, started and cancelled at connection
/// scope by `ConnectionHandle` so cues keep firing across module switches,
/// mirroring `UserListViewModel`.
@MainActor
