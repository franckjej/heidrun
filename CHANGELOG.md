...
- Connecting from the tracker window now adds the server to Recent Servers, like the connect form does.
...
- **Protocol Console:** server popup and text field filter the transcript.
